...
public class FingerLeftAnimation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            else if (Input.GetKey(KeyCode.LeftArrow) && Input.GetKey(KeyCode.Space) == false && Nose_Charge == false && Nose_Dush == false)
            {
                anima.SetBool("FingerIN", true);
            }
